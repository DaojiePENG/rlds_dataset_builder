...
> Go to [`rlds_dataset_builder/le_robot_to_rlds/prepare_lerobot_dataset_npy.ipynb`](le_robot_to_rlds/prepare_lerobot_dataset_npy.ipynb)for a two-steps example of converting LeRobot dataset to RLDS dataset.
